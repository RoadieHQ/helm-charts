...
secretsSettings:
  ...
  secrets:
    ...
    - name: PAGERDUTY_TOKEN
      ...
      helpUrl: https://roadie.io/docs/integrations/pagerduty/
{{- end }}
...
single-sign-on:
  name: vouch
  {{- if .Values.singleSignOn.backstageIdentityProvider }}
  backstageIdentityProvider: {{ .Values.singleSignOn.backstageIdentityProvider }}
  {{- end }}
  config:
